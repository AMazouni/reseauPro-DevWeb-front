...
set messageShowDetail (value: boolean ) {
  ...
  public findAll(){
  this.http.get<Array<MessageVo>>('http://localhost:8080/uca/reseaupro/message/').subscribe(
    value => {
      if (value != null) {
  ...
  public saveMessage() {
  this.http.post<MessageVo>('http://localhost:8080/uca/reseaupro/message/', this.message).subscribe(data=>{
    this.createHide();
  ...
  public editMessage() {
  this.http.put<MessageVo>('http://localhost:8080/uca/reseaupro/message/', this.message).subscribe(data=>{
    this.editHide();
  });
      this.message.destinataireVo.length = 0;
  ...
  this.http.post<Array<MessageVo>>('http://localhost:8080/uca/reseaupro/message/search/', pojo).subscribe(
    value =>{
       this.messageListe = value;  
    } );
}
...
delete(pojo: MessageVo) {
   this.http.delete<MessageVo>('http://localhost:8080/uca/reseaupro/message/id/'+pojo.id).subscribe(
        value => {
...
if (index > -1) {
   this.messageListe.splice(index, 1);
      ...
      this.http.get<MessageVo>('http://localhost:8080/uca/reseaupro/message/ref/' + ref).subscribe(
        value => {
